...
/*1*/	{"DJNZ", &a::DJNZ, &a::IMM, 2}	, NOP_INST						, NOP_INST						, NOP_INST						, {"INCD", &a::INCD, &a::IMP, 1}, NOP_INST						, {"LDDN", &a::LDDN, &a::IMM, 2}, NOP_INST						, NOP_INST						, NOP_INST						, NOP_INST						, NOP_INST						, {"INCE", &a::INCE, &a::IMP, 1}, NOP_INST						, {"LDEN", &a::LDEN, &a::IMM, 2}, NOP_INST						,
/*2*/	NOP_INST						, NOP_INST						, NOP_INST						, NOP_INST						, {"INCH", &a::INCD, &a::IMP, 1}, NOP_INST						, {"LDHN", &a::LDHN, &a::IMM, 2}, NOP_INST						, NOP_INST						, NOP_INST						, NOP_INST						, NOP_INST						, {"INCL", &a::INCL, &a::IMP, 1}, NOP_INST						, {"LDLN", &a::LDLN, &a::IMM, 2}, NOP_INST						,
